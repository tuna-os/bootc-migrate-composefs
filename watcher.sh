...
WHITELIST="${5:-WARN:|Warning:|warn:|WARNING|Timeout: 0 seconds|Read-only file system|mkdir: Read-only|mkdir: Permission|blockdev failed|remount failed|mkdir failed|couldn.*open.*temporary}"
