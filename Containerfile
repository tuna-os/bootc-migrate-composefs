# Minimal OCI image distributing the bootc-migrate-composefs binary.
#
...
#       /usr/local/bin/bootc-migrate-composefs /usr/local/bin/
#
...
ARG TARGETARCH
COPY linux/${TARGETARCH}/bootc-migrate-composefs /usr/local/bin/bootc-migrate-composefs
ENTRYPOINT ["/usr/local/bin/bootc-migrate-composefs"]
